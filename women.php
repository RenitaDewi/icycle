...
<div class="wrap">	
	<div class="main">
    <h2 class="style top">Featured For Women</h2>
		<!-- start grids_of_3 -->
...
$current_url = base64_encode("http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']); 
    $results = mysql_query("SELECT * FROM listproduk WHERE idProduk='fix001w' ORDER BY idProduk");
    if ($results) { 
...
//current URL of the Page. cart_update.php redirects back to this URL
$current_url = base64_encode("http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']); 
    $results = mysql_query("SELECT * FROM listproduk WHERE idProduk='fix002w' ORDER BY idProduk");
    if ($results) { 
        //output results from database
        while($obj = mysql_fetch_object($results))
        {
...
//current URL of the Page. cart_update.php redirects back to this URL
$current_url = base64_encode("http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']); 
    $results = mysql_query("SELECT * FROM listproduk WHERE idProduk='fix003w' ORDER BY idProduk");
    if ($results) {
        //output results from database
        while($obj = mysql_fetch_object($results))
        {
...
//current URL of the Page. cart_update.php redirects back to this URL
$current_url = base64_encode("http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']); 
    $results = mysql_query("SELECT * FROM listproduk WHERE idProduk='fix004w' ORDER BY idProduk");
    if ($results) { 
        //output results from database
        while($obj = mysql_fetch_object($results))
        {
...
//current URL of the Page. cart_update.php redirects back to this URL
$current_url = base64_encode("http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']); 
    $results = mysql_query("SELECT * FROM listproduk WHERE idProduk='fix005w' ORDER BY idProduk");
    if ($results) { 
        //output results from database
        while($obj = mysql_fetch_object($results))
        {
...
//current URL of the Page. cart_update.php redirects back to this URL
$current_url = base64_encode("http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']); 
    $results = mysql_query("SELECT * FROM listproduk WHERE idProduk='fix006w' ORDER BY idProduk");
    if ($results) { 
        //output results from database
        while($obj = mysql_fetch_object($results))
        {
