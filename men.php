...
<div class="wrap">	
	<div class="main">
    <h2 class="style top">Featured For Men</h2>
		<!-- start grids_of_3 -->
...
$current_url = base64_encode("http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']); 
    $results = mysql_query("SELECT * FROM listproduk WHERE idProduk='fix001m' ORDER BY idProduk");
    if ($results) { 
...
//current URL of the Page. cart_update.php redirects back to this URL
$current_url = base64_encode("http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']); 
    $results = mysql_query("SELECT * FROM listproduk WHERE idProduk='fix002m' ORDER BY idProduk");
    if ($results) { 
        //output results from database
        while($obj = mysql_fetch_object($results))
        {
...
//current URL of the Page. cart_update.php redirects back to this URL
$current_url = base64_encode("http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']); 
    $results = mysql_query("SELECT * FROM listproduk WHERE idProduk='fix003m' ORDER BY idProduk");
    if ($results) { 
        //output results from database
        while($obj = mysql_fetch_object($results))
        {
...
//current URL of the Page. cart_update.php redirects back to this URL
$current_url = base64_encode("http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']); 
    $results = mysql_query("SELECT * FROM listproduk WHERE idProduk='fix004m' ORDER BY idProduk");
    if ($results) { 
        //output results from database
        while($obj = mysql_fetch_object($results))
        {
...
//current URL of the Page. cart_update.php redirects back to this URL
$current_url = base64_encode("http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']); 
    $results = mysql_query("SELECT * FROM listproduk WHERE idProduk='fix005m' ORDER BY idProduk");
    if ($results) { 
        //output results from database
        while($obj = mysql_fetch_object($results))
        {
...
//current URL of the Page. cart_update.php redirects back to this URL
$current_url = base64_encode("http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']); 
    $results = mysql_query("SELECT * FROM listproduk WHERE idProduk='fix006m' ORDER BY idProduk");
    if ($results) { 
        //output results from database
        while($obj = mysql_fetch_object($results))
        {
