...
<div class="wrap">	
	...
	<div class="single">
			...
			<div class="span1_of_1_des">
				  <div class="desc1">
					<h3>Ethnicneon Fixie Trick </h3>
					<p>1 year guarantee</p>
                     
					<h5>$370 <a href="#">click for offer</a></h5>
					<div class="available">
			   	...
			   	<!-- start tabs -->
			        ...
			        <label for="tab-2" class="tab-label-2">spesification</label>
			        ...
			        <div class="content">
				        <div class="content-1">
				        	<p class="para top"><span>Ethnicneon Fixie Trick</span> intended for young stylish passengers . This fixie avoid oily chains , complex tubes with hidden dirt traps and chaos features a traditional bike . MODE feature IF ( Integrated Folding ) technology Pacific, offering one - act , automatic folding that requires no tools or removal of parts . IF patented technology is based on 3 - dimensional 4 - bar linkage that automatically guides the wheels together when folding . Once folded , the MODE rolls together in one convenient package wheelable . </p>
							<ul>
								<li>Research</li>
				        ...
				        <div class="content-2">
							<p class="para"><span>Spesification of Ethnicneon Fixie Trick </span> General Features : </p>
							<ul class="qua_nav">
                                <li>SKU		: AD943SPARPGFANID-649102</li>
								<li>Price	: $370</li>
								<li>Size	: 12 x 3 x 90</li>
                                <li>Weight	: 3kg</li>
							</ul>
						</div>
    ...
    <p1>USERNAME	: <INPUT TYPE="text" NAME="username"></p1>
