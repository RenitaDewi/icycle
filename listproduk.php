...
<div class="wrap">	
    ...
    <h2 class="style top">Featured For Product</h2><br></br>
		<!-- start grids_of_3 -->
      <div class="feat_prod_box">
	  <form name="tiga" method="post">
	  <table border='1' align='center'>
            <tr><th>Nama Produk</th><th>Kategori</th><th>Stok</th><th>Harga</th><th>Gambar</th><th></th></tr>
                ...
                <?php
                    ...
                    $query = "SELECT * FROM listproduk ORDER BY nama ";
					...
					<td><a href="viewdetailproduk.php?id=<?php echo $row['idProduk'] ?>">LIHAT</a></td>
					</tr>
                <?php
                    $no++;
                    }
